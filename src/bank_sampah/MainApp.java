...
import bank_sampah.modules.register.RegisterView;
...
public class MainApp extends Application {
    ...
    public static void showLogin() {
        ...
        addStylesheet(scene,
                "bank_sampah/resources/app.css");

        addStylesheet(scene,
                "bank_sampah/modules/login/login.css");

        mainStage.setTitle(
                "Login - Sistem Informasi Bank Sampah"
        );
    ...
    public static void showRegister() {
        ...
        addStylesheet(scene,
                "bank_sampah/modules/register/register.css");

        mainStage.setTitle(
                "Daftar Akun - Sistem Informasi Bank Sampah"
        );
    ...
    public static void showAdminPage(String page) {
        ...
        switch (page) {
            ...
            case "jenis_sampah":
                ...
                mainStage.setTitle(
                        "Jenis Sampah - Bank Sampah"
                );
                break;

            case "transaksi_setor":
                adminRoot.setCenter(
                        new TransaksiSetorView().getView()
                );

                mainStage.setTitle(
                        "Transaksi Setor - Bank Sampah"
                );
                break;

            case "penukaran_poin":
                adminRoot.setCenter(
                        new PenukaranPoinView().getView()
                );

                mainStage.setTitle(
                        "Penukaran Poin - Bank Sampah"
                );
                break;

            case "laporan":
                adminRoot.setCenter(
                        new LaporanView().getView()
                );
        ...
        addStylesheet(scene,
                "bank_sampah/modules/dashboard/dashboard.css");

        addStylesheet(scene,
                "bank_sampah/modules/nasabah/nasabah.css");

        addStylesheet(scene,
                "bank_sampah/modules/jenis_sampah/jenis-sampah.css");

        addStylesheet(scene,
                "bank_sampah/modules/transaksi_setor/transaksi-setor.css");

        addStylesheet(scene,
                "bank_sampah/modules/penukaran_poin/penukaran-poin.css");

        addStylesheet(scene,
                "bank_sampah/modules/laporan/laporan.css");
