...
public class JenisSampahView {
    ...
    public ScrollPane getView() {
        ...
        cards.getChildren().addAll(
                ...
                card("Rata-rata Harga", "Rp 3.450", "Berdasarkan semua jenis")
        );
    ...
    private VBox createTableBox() {
        ...
        table.getColumns().addAll(noCol, namaCol, kategoriCol, hargaCol);
        ...
        search.textProperty().addListener((obs, oldVal, keyword) -> {
            ...
            if (k.isEmpty()) {
                ...
                table.setItems(controller.getData().filtered(s ->
