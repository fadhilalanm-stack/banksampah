...
public class PenukaranPoin {
    ...
    public PenukaranPoin(int idPenukaran, String tanggal, String namaNasabah, int jumlahPoin, String reward, String status) {
    ...
    public int getIdPenukaran() { return idPenukaran; }
